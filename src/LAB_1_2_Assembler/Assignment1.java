 ...
 * Devesh Bhogre
 * PB47 PANEL 2
 * Assembler Pass1 and Pass2
 */


package LAB_1_2_Assembler;
...
public class Assignment1 { 
    ...
    //Pass 2 of the assembler to generate Machine code from inter
    public static void Pass2() {
        System.out.println("--------- Pass2 Output-----------");
        LocationCounter = 0;
        String MCLine;
    ...
    public static void main(String[] args) throws IOException {        
        ...
        Pass1(loc);
        var fileWriter=new FileWriter("src/LAB_1_2_Assembler/IntermediateCode.txt");
        ...
        Pass2();
        fileWriter=new FileWriter("src/LAB_1_2_Assembler/MachineCode.txt");
